...
export function Hero() {
  ...
  return (
    <section className="relative flex min-h-[60vh] sm:min-h-[820px] items-center justify-center overflow-hidden">
      ...
      {/* === LOGO BR 35 + TEXTE === */}
      <div className="relative z-40 mx-auto flex max-w-5xl flex-col items-center px-4 text-center">
        <div className="mb-5 flex flex-wrap sm:flex-nowrap items-center justify-center gap-2 md:gap-3">
          {/* Carré Br 35 style tableau périodique */}
          <div className="relative flex h-16 w-16 md:h-24 md:w-24 shrink-0 items-center justify-center rounded-xl bg-[#3e6757] text-white shadow-[0_0_40px_rgba(62,103,87,0.5)]">
            <span className="text-4xl md:text-[68px] font-black tracking-tighter">Br</span>
            <span className="absolute right-1.5 top-1 md:right-2 md:top-1 text-[10px] md:text-sm font-bold">35</span>
          </div>

          <div className="flex items-baseline font-bold tracking-[-1.5px] md:tracking-[-3.5px] text-white">
            <span className="text-4xl sm:text-[50px] md:text-[64px]">eakingBad</span>
            <span className="ml-1 text-4xl sm:text-[50px] md:text-[64px] text-[#3e6757]">33</span>
          </div>
        </div>
      </div>
    </section>
